...
INSERT INTO `evento` (`id`, `caminho_imagem_do_evento`,`data_evento`,`hora_evento`,`nome`,`quantidade_ingressos`,`quantidade_ingressos_disponiveis`,`quantidade_ingressos_vendidos`,`tipo`,`valor`,`local_id`)
VALUES (1, 'ImagensDosEventos/1.jpg',"2022-12-12","20:00:00", 'Braba - Luisa Sonza', 5000, 4999, 1, 'MUSICAL', 165.00, 3);

INSERT INTO `evento` (`id`, `caminho_imagem_do_evento`,`data_evento`,`hora_evento`,`nome`,`quantidade_ingressos`,`quantidade_ingressos_disponiveis`,`quantidade_ingressos_vendidos`,`tipo`,`valor`,`local_id`)
VALUES (2, 'ImagensDosEventos/2.jpg',"2022-12-12","20:00:00", 'As patroas - Marilia Mendoça', 4000, 3990, 10, 'MUSICAL', 120.00, 3);
